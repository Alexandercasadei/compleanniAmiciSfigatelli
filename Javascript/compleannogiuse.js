		...
		var x = setInterval(function() {
			...
			if (distance < 0) {
				clearInterval(x);
				document.getElementById("countdown").innerHTML = "Countdown finito auguri Giuse";
				countDownDate = new Date("April 11, " + (new Date().getFullYear() + 1) + " 00:00:00").getTime(); // Set the date for next year's countdown
			}
		}, 1000);
