		...
		var x = setInterval(function() {
			...
			if (distance < 0) {
				clearInterval(x);
				document.getElementById("countdown").innerHTML = "Countdown finito auguri Shadow";
				countDownDate = new Date("may 16, " + (new Date().getFullYear() + 1) + " 00:00:00").getTime(); // Set the date for next year's countdown
			}
		}, 1000);
